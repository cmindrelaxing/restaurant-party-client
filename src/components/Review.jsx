        ...
        <div className='mb-20'>
            <div className='area mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-10'>
                <div className='space-y-10 box_hover'>
                    <div className='bg-[#222831] p-5 space-y-5 rounded-lg'>
                    ...
                    <div className=' img_box img_box border-[6px] border-[#5dff33] w-[130px] h-[130px] mx-auto md:mx-0 rounded-full overflow-hidden'>
