                ...
                <div className="area mx-auto grid grid-cols-1 md:grid-cols-3">
                    <div className='mb-16 md:mb-0'>
                        ...
                        <div className='mt-5 space-y-2 social'>
                            <p className='hover:text-[#ffbe33]'><i className=' bx bxs-edit-location'></i> <span>Location</span> </p>
                            <p className='hover:text-[#ffbe33]'><i className=' bx bxs-phone-call'></i> <span>Call +01 400886906</span> </p>
                            <p className='hover:text-[#ffbe33]'><i className=' bx bxs-envelope'></i> <span>cmindrelaxing1@gmail.com</span> </p>
                        </div>
                    </div>
                    <div className='text-center mb-16 md:mb-0'>
                        ...
                        <div className='mt-5 space-y-3 social'>
                            <p className=''><span>Necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with</span> </p>
                    ...
                    <div className='text-right'>
                        ...
                        <div className='mt-5 space-y-2 social'>
                            ...
                            <p> <span>10.00 Am -10.00 Pm</span> </p>
                        </div>
                    </div>
                </div>
            </div>
            <div className='text-center mt-8 md:mt-6'>
                <small className='text-white'>Copyright &copy; Restaurant Party. All Rights Reseved.</small>
            </div>
        </div>
    );
};
