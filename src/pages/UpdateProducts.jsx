        ...
        <div className=" min-h-screen bg-base-200 flex items-center justify-center py-20 ">
            <div className="hero-content w-full flex-col-reverse md:flex-row justify-center">
                ...
                <div className="card flex-shrink-0 w-full shadow-2xl bg-base-100 md:w-[55%]">
                    <form onSubmit={updateItem} className="card-body" data-aos="flip-right">
                        <h2 className="text-2xl font-semibold text-center dancing">Update Product</h2>
                        ...
                        <button className="btn text-white py-2 bg-[#5dff33] capitalize hover:bg-black hover:text-white rounded-full">Update Collection</button>
                        </div>
